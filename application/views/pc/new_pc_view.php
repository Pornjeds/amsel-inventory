<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">สร้างโปรไฟล์ PC ใหม่</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open_multipart('VerifyNewUser', $attributes); ?>
                    <!-- <form method="post" name="registration" action="/index.php/pc/create"> -->
                      <div class="row">
                        <div class="col-md-2">
